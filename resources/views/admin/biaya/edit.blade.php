...
<h1 align="center">Form edit Biaya</h1><br>
<form method="post" action="{{url('admin/biaya/update')}}" enctype="multipart/form-data">
    {{csrf_field()}}
<div class="card-body">
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text1" name="tgl_pembayaran" type="date" class="form-control" value="{{$b->tgl_pembayaran}}">
    </div>
  </div>
  <div class="form-group row">
    <label for="text1" class="col-4 col-form-label">Jumlah Pembayaran</label> 
    <div class="col-8">
      <input id="text1" name="jml_pembayaran" type="text" class="form-control" value="{{$b->jml_pembayaran}}">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <div>
            ...
            @else
                <img src="{{url('admin/image')}}/{{$b->bukti_pembayaran}}" width="20%">
            @endempty
        </div>
    </div>
  </div> 
